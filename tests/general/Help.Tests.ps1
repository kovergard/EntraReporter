...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraReporter\functions", "$global:testroot\..\EntraReporter\internal\functions"),
	
	[string]
	$ModuleName = "EntraReporter",
...
$CommandPath = @(
    "$global:testroot\..\EntraReporter\functions"
    "$global:testroot\..\EntraReporter\internal\functions"
)
