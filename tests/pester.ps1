...
Remove-Module EntraReporter -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraReporter\EntraReporter.psd1"
Import-Module "$PSScriptRoot\..\EntraReporter\EntraReporter.psm1" -Force
